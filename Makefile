...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Dec 14 20:17:54 2012
# Project:  final.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		glm.cpp \
		targa.cpp \
		particleemitter.cpp moc_mainwindow.cpp \
		moc_view.cpp
OBJECTS       = main.o \
		mainwindow.o \
		view.o \
